...
compile2.5:
	g++ -c main.cpp GlobalConfigs.cpp Div.cpp DataNode.cpp Parser.cpp EditorSpace.cpp Tab.cpp TabTray.cpp Explorer.cpp FileOperations.cpp Buffer.cpp langHighlight/*.cpp langHighlight/cpp/*.cpp -I${sfmlPath}/include -std=c++11
